        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<c:url value="/get-projects" />" class="waves-effect"><i class="fa fa-table fa-fw"
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <a href="#" class="group-title">
                            ...
                            <span class="executorName">Pavan kumar</span>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <div class="white-box">
                            <h3 class="box-title statusName">Chưa thực hiện</h3>
                            <div class="message-center">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5 class="projectName">Pavan kumar</h5> 
                                        <span class="mail-desc taskName">Just see the my admin!</span> 
                                        <span class="time startDate">9:30 AM</span>
                                        <span class="time endDate">6:00 PM</span>
                                    </div>
                                </a>
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5 class="projectName">Sonu Nigam</h5> 
                                        <span class="mail-desc taskName">I've sung a song! See you at</span>
                                        <span class="time startDate">9:10 AM</span>
                                        <span class="time endDate">6:00 PM</span>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            <h3 class="box-title statusName">Đang thực hiện</h3>
                            <div class="message-center">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5 class="projectName">Pavan kumar</h5> 
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            <h3 class="box-title statusName">Đã hoàn thành</h3>
                            <div class="message-center">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5 class="projectName">Pavan kumar</h5> 
